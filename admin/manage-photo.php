            ...
            <header class="header-admin-amti">
                ...
                <div class="top-menu-admin">
                    <ul>
                        ...
                        <li class="list-your">
                            <a href="../list-your-place" class="list-your-place">
                                List Your Place
                            </a>
                        </li>
                    </ul>
                ...
                <div class="site-calendar-amti">
                    <div class="left-calendar-amti">
                        ...
                        <div class="description">
                            ...
                            <ul>
                                ...
                                <li><a class="phot" href="manage-photo.php">Photo</a></li>
                            </ul>
                        </div>
                        <div class="settings">
                            <h6>Settings</h6>
                    ...
                    <div class="right-calendar-amti">
                        <div class="site-right-calendar-amti">
                                <div class="cam"></div>
                                <p class="under-cam">Add a photo or two!</p>
                                <p class="exp-under">Or three, or more! Guests love photos that<br> highlight the features of your space.</p>
                                <div class="upld"><a href="#"><img src="../images/upload.png">Add Photos</a></div>
                        </div>
                    </div>
                </div>
            </div>

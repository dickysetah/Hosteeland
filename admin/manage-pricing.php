                ...
                <div class="site-calendar-amti">
                    <div class="left-calendar-amti">
                        <div class="basics">
                            ...
                            <ul>
                                ...
                                <li><a class="price" href="manage-pricing.php">Pricing</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="right-calendar-amti">
                        <div class="site-right-calendar-amti">
                                ...
                                <p class="under-base">The base nightly price<br> and default currency for your<br> listing.</p>
                            <p class="title-price">Per night</p>
                            <form class="night-price">
                               <input class="price-night" type="text" name="prc" placeholder="" required="" tabindex="1"><span>Rp</span>
                            </form>
                            <p class="title-price">Currency</p>
                            <div class="matang">
                            ...
                            <hr class="garis">
                            <p class="bisa-bulanan">Want to offer a discount for longer stays? <span><a href="#">You can also set weekly and monthly prices.</a></span></p>
                        </div>
                    </div>
                </div>
            </div>
